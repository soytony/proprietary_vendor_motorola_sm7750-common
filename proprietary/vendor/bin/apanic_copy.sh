...
if [ -e /dev/block/bootdevice/by-name/xbl_sc_logs ] ; then
    cat /dev/block/bootdevice/by-name/xbl_sc_logs > /data/vendor/dontpanic/xbl_sc_logs
    chown root:log /data/vendor/dontpanic/xbl_sc_logs
    chmod 0640 /data/vendor/dontpanic/xbl_sc_logs
fi
